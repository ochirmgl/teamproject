...
ENGLISH_FOLLOW_UP_STOPWORDS = {
    ...
    "us", "was", "were", "what", "why", "would", "you", "when", "which",
}
...
QUERY_STOPWORDS = {
    ...
    "оноос", "онд", "эхлэн", "гол", "агуулгыг", "агуулгын",
}
...
class DocumentRAG:
    ...
    def retrieve(
        ...
        aliases = {'amralt':'амралт','leave':'амралт','vacation':'амралт',
                   ...
                   'regulation':'журам','regulations':'журам','policy':'журам',
                   'start':'эхлэх','starts':'эхлэх','effective':'мөрдөх',
                   'expense':'зардал','expenses':'зардал','ownership':'өмчлүүлэх',
                   'witness':'гэрч','confidentiality':'нууцлал','safety':'аюулгүй',
                   'workplace':'хөдөлмөр','instructions':'зааварчилгаа',
                   'disciplinary':'сахилгын','appeal':'гомдол','investment':'хөрөнгө'}
